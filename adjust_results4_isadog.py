...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    """         
    dic_dognames = {}   # Dictionary for names of dogs
    with open(dogfile, "r") as infile:   # Using the with keyword to read and close the files in dognames
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dic_dognames:
            
            # Classifier Label IS image of Dog (e.g. found in dognames_dic)
            # appends (1, 1) because both labels are dogs
            if results_dic[key][1] in dic_dognames:
